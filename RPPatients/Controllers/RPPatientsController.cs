...
{
    public class RPPatientsController : Controller
    {
        private readonly PatientsContext _context;

        public RPPatientsController(PatientsContext context)
        {
            _context = context;
        }
